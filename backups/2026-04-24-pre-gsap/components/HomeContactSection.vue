    ...
    <div class="container">
      ...
      <div class="cta-ref">
        <div class="cta-ref__media">
          <img :src="homeCta.image" :alt="homeCta.imageAlt" loading="lazy">
        </div>

        <div class="cta-ref__content">
          <h2 class="cta-ref__title">
            <span>{{ homeCta.titleTop }}</span>
            <em>{{ homeCta.titleScript }}</em>
            <span>{{ homeCta.titleBottom }}</span>
          </h2>

          <p class="cta-ref__descr">
            {{ homeCta.description }}
          </p>
            ...
            <div class="cta-ref__messengers">
              ...
              >
                <svg width="20" height="20" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path
                    ...
                    fill="url(#paint0_linear_cta_max)"
                  />
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                  ...
                  />
                  <defs>
                    <linearGradient id="paint0_linear_cta_max" x1="-2.13509e-08" y1="20.8374" x2="40.7013" y2="23.7031" gradientUnits="userSpaceOnUse">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 33 32" fill="none" aria-hidden="true">
                  <g clip-path="url(#clip0_cta_telegram)">
                    <path d="M16.5 0C12.2575 0 8.185 1.68675 5.1875 4.68625C2.18693 7.68696 0.500859 11.7565 0.5 16C0.5 20.2417 2.1875 24.3142 5.1875 27.3137C8.185 30.3132 12.2575 32 16.5 32C20.7425 32 24.815 30.3132 27.8125 27.3137C30.8125 24.3142 32.5 20.2417 32.5 16C32.5 11.7583 30.8125 7.68575 27.8125 4.68625C24.815 1.68675 20.7425 0 16.5 0Z" fill="url(#paint0_linear_cta_telegram)"/>
                  ...
                  <defs>
                    <linearGradient id="paint0_linear_cta_telegram" x1="1600.5" y1="0" x2="1600.5" y2="3200" gradientUnits="userSpaceOnUse">
                      <stop stop-color="#2AABEE" />
                      <stop offset="1" stop-color="#229ED9" />
                    </linearGradient>
                    <clipPath id="clip0_cta_telegram">
          ...
          <label class="cta-ref__consent">
            ...
            <span>{{ homeCta.consentLabel }}</span>
          </label>
        </div>
      </div>
    </div>
