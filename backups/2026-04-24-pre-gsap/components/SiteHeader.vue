    ...
    <div class="header-bottom" :class="{ 'header-bottom--sticky': stickyHeaderVisible }">
      <div class="container">
        <NuxtLink to="/" class="header-bottom__logo brand-mark brand-mark--hero" aria-label="Magic Iris">
          <span class="brand-mark__word">magic</span>
          <span class="brand-mark__accent">iris</span>
        </NuxtLink>
        ...
        <div v-if="menuOpen" id="mobile-menu" class="mobile-menu">
          ...
          <div class="mobile-menu__panel">
            ...
            <div class="mobile-menu__contacts">
              ...
              <a :href="contactInfo.telegram" target="_blank" rel="noreferrer">Telegram</a>
              <a :href="contactInfo.max || contactInfo.whatsapp" target="_blank" rel="noreferrer">MAX</a>
              <a :href="contactInfo.vk" target="_blank" rel="noreferrer">VK</a>
            </div>
