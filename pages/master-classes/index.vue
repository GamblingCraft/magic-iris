  ...
  <div class="catalog-shell">
    ...
    <section class="section catalog-shell__section">
      <div class="container">
        <CatalogCardsSection
          eyebrow="Подборки"
          title="Выберите направление — подберём идеи"
          description="Взрослые, школьники, открытые площадки или сезонные праздники: посмотрите подборку, которая подходит именно вашему событию."
          :items="categoryCards"
        />
      </div>
    </section>
      ...
      <div class="container">
        <div class="catalog-filter-panel">
          <div class="catalog-cards-section__head">
            ...
            <p>Выберите направление, чтобы сразу увидеть форматы, которые подходят для женских встреч, школьных групп, сезонных праздников или летних площадок.</p>
          </div>
    ...
    <section class="section catalog-shell__section catalog-shell__section--tight">
      <div class="container">
        <CatalogCarouselSection
          eyebrow="Популярные"
          title="Форматы, которые хорошо работают на праздниках"
          description="Эти мастер-классы легко встраиваются в тайминг, красиво смотрятся на площадке и вовлекают гостей с первых минут."
    ...
    <section class="section catalog-shell__section catalog-shell__section--tight">
      <div class="container">
        <CatalogCarouselSection
          eyebrow="Рекомендуем"
          title="Идеи, с которых приятно начать"
          description="Спокойные, красивые и универсальные форматы для камерных праздников, творческих зон и событий, где важна эстетика."
    ...
    <section class="section catalog-shell__section catalog-shell__section--tight">
      <div class="container">
        <CatalogCardsSection
          ...
          title="Ещё идеи для вдохновения"
          description="Посмотрите разные форматы и сохраните те, которые откликаются по атмосфере, визуалу и результату для гостей."
