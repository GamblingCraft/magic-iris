...
const { data: pageData } = await useFetch<ShowCollectionPage>('/api/site/landing-pages/den-rozdenia', {
  key: 'den-rozdenia.vue-landing-page'
})
  ...
  script: [
    {
      ...
      children: JSON.stringify([
        ...
        },
        {
          ...
          areaServed: '\u0418\u0440\u043a\u0443\u0442\u0441\u043a',
          serviceType: '\u0428\u043e\u0443 \u043d\u0430 \u0434\u0435\u043d\u044c \u0440\u043e\u0436\u0434\u0435\u043d\u0438\u044f',
          provider: {
            '@type': 'Organization',
            name: 'Magic Iris',
