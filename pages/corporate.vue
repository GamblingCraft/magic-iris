...
const { data: pageData } = await useFetch<ServiceLandingPage>('/api/site/service-pages/corporate', {
  key: 'corporate-service-page'
})
  ...
  script: [
    {
      ...
      children: JSON.stringify([
        ...
        },
        {
          ...
          areaServed: 'Иркутск',
          serviceType: 'Творческие форматы для корпоративных клиентов',
          provider: {
            '@type': 'Organization',
            name: 'Magic Iris',
