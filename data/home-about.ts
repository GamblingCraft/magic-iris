...
export const aboutSeoParagraphs = [
  'Magic Iris — творческая студия в Иркутске, которая помогает превратить частное или корпоративное событие в цельное впечатление: с красивой подачей, спокойной организацией и сильной эмоциональной кульминацией.',
  'Мы работаем со свадьбами, днями рождения, корпоративами, юбилеями, выпускными и городскими событиями, создавая песочное шоу, световое шоу, шоу-портреты и выездные мастер-классы под формат площадки и состав гостей.',
  'Если вам нужен праздник под ключ или отдельный визуальный номер, подберём решение по атмосфере, таймингу, бюджету и задаче события — от камерного вечера до большой сцены.'
]
